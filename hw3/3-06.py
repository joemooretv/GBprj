...
# Не понял, нужно было циклом пройтись?
# Иначе непонятно зачем избыточный код.
# Как обрабатывать ошибки тоже неясно
def int_func(word):
    return word.capitalize()


while True:
    words = list(input('enter non-capitalized words: ').split(' '))
    res = ''
